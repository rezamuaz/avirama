...
class PilihSpg extends StatefulWidget {
  List dataList;

  PilihSpg(this.dataList, {super.key});

  @override
  State<PilihSpg> createState() => _PilihSpgState();
}

class _PilihSpgState extends State<PilihSpg> {
  List dataFix = [];
