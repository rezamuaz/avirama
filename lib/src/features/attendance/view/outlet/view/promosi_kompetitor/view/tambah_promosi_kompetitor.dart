...
class TambahPromosiKomptetitorView extends StatefulWidget {
  final int id_outlet;
  final KompetitorPromo? data_edit;

  const TambahPromosiKomptetitorView(this.id_outlet,
      {super.key, this.data_edit});

  @override
  State<TambahPromosiKomptetitorView> createState() =>
      _TambahPromosiKomptetitorViewState();
}

class _TambahPromosiKomptetitorViewState
    extends State<TambahPromosiKomptetitorView> {
    ...
    return MultiBlocProvider(
      ...
      child: Scaffold(
        ...
        body: Builder(builder: (context) {
          return BlocListener<PromoCompetitorBloc, PromoCompetitorState>(
