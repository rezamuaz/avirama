...
class DaftarProdukKompetitorEmpty extends StatefulWidget {
  final int idOutlet;
  final List<KompetitorProduct> dataOrigin;

  const DaftarProdukKompetitorEmpty(this.idOutlet, this.dataOrigin,
      {super.key});

  @override
  State<DaftarProdukKompetitorEmpty> createState() =>
      _DaftarProdukKompetitorEmptyState();
}

class _DaftarProdukKompetitorEmptyState
    extends State<DaftarProdukKompetitorEmpty> {
  @override
